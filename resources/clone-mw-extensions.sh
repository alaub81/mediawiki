...
#git clone -b $MW_BRANCH "https://gerrit.wikimedia.org/r/mediawiki/extensions/CirrusSearch"
#git clone -b $MW_BRANCH "https://gerrit.wikimedia.org/r/mediawiki/extensions/Elastica"
